...
public class GameCharacter
{
    ...
    {
        int weaponMissChance = _equippedWeapon== null?0:_equippedWeapon.getMissChance();

        int hitChance = currentAgility;
        int failChance = weaponMissChance+ target.getCurrentAgility();
