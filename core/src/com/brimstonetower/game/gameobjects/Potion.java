...
public class Potion extends Item
{
    ...
    public Potion(String identifiedName,String description,Effect effect,boolean isIdentified,TextureRegion textureRegion,Color color,int typeId)
    {
    ...
    {
        this(toCopy.getName(),toCopy.getDescription(), toCopy.getEffect(),toCopy.isIdentified(), toCopy.getTextureRegion(),toCopy.getColor(),toCopy.getTypeId());
    }
